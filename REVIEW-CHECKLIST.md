...
Content passes recorded: **464/644**. Final individual review pending: **180**. Changed since the recorded revision: **0**.
...
| Testing, Security, Reliability, and SaaS Operations | 0 | 10 | 0 |
| Cloud and AWS Complete Deep Dive | 0 | 32 | 0 |
| DevOps Complete Deep Dive | 0 | 20 | 0 |
| Docker Complete Deep Dive | 0 | 20 | 0 |
| Kubernetes Complete Deep Dive | 0 | 30 | 0 |
| Mathematics and Machine Learning Foundations | 0 | 4 | 0 |
| LLM and Transformer Internals | 0 | 5 | 0 |
| AI Application Engineering | 0 | 8 | 0 |
| Search, Embeddings, and RAG | 0 | 9 | 0 |
| Agents and Durable AI Workflows | 0 | 9 | 0 |
| AI Evaluations, Observability, and Safety | 0 | 6 | 0 |
| Production Capstone | 0 | 4 | 0 |
| International Interviews and Relocation Readiness Complete Module | 0 | 23 | 0 |
...
| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0465 · Test strategy, boundaries, contracts, and test doubles](lessons/0465-test-strategy-boundaries-contracts-and-test-doubles.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0466 · Property-based, concurrency, load, chaos, and regression testing](lessons/0466-property-based-concurrency-load-chaos-and-regression-testing.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0467 · Threat modeling, secure design, authentication, authorization, and secrets](lessons/0467-threat-modeling-secure-design-authentication-authorization-and-secrets.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0468 · Web, API, dependency, and supply-chain security](lessons/0468-web-api-dependency-and-supply-chain-security.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0469 · Reliability targets, observability, incidents, and postmortems](lessons/0469-reliability-targets-observability-incidents-and-postmortems.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0470 · Production webhooks, event contracts, signatures, timestamps, replay defense, idempotency, retries, ordering, and secret rotation](lessons/0470-production-webhooks-event-contracts-signatures-timestamps-replay-defense.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0471 · Application file storage, direct uploads, presigned URLs, multipart transfer, validation, malware scanning, metadata, lifecycle, and delivery](lessons/0471-application-file-storage-direct-uploads-presigned-urls-multipart-transfe.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0472 · Background jobs, queues, leases, acknowledgements, retries, idempotency, scheduling, dead letters, and worker shutdown](lessons/0472-background-jobs-queues-leases-acknowledgements-retries-idempotency-sched.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0473 · Audit logs, actors, actions, targets, outcomes, correlation, tamper evidence, retention, privacy, and investigation](lessons/0473-audit-logs-actors-actions-targets-outcomes-correlation-tamper-evidence-r.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0474 · Admin systems, privileged workflows, RBAC, impersonation, approvals, bulk operations, safety rails, and observability](lessons/0474-admin-systems-privileged-workflows-rbac-impersonation-approvals-bulk-ope.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Cloud and AWS Complete Deep Dive

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0475 · Cloud mental models, shared responsibility, elasticity, regions, managed services, and tradeoffs](lessons/0475-cloud-mental-models-shared-responsibility-elasticity-regions-managed-ser.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0476 · AWS global infrastructure, Regions, Availability Zones, edge locations, partitions, and service scope](lessons/0476-aws-global-infrastructure-regions-availability-zones-edge-locations-part.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0477 · AWS accounts, Organizations, organizational units, SCPs, Control Tower, and landing zones](lessons/0477-aws-accounts-organizations-organizational-units-scps-control-tower-and-l.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0478 · AWS CLI, SDKs, profiles, credential provider chain, SigV4, endpoints, and retries](lessons/0478-aws-cli-sdks-profiles-credential-provider-chain-sigv4-endpoints-and-retr.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0479 · IAM identities, policies, resources, conditions, evaluation logic, boundaries, and explicit deny](lessons/0479-iam-identities-policies-resources-conditions-evaluation-logic-boundaries.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0480 · STS, role assumption, federation, IAM Identity Center, OIDC, session policies, and temporary credentials](lessons/0480-sts-role-assumption-federation-iam-identity-center-oidc-session-policies.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0481 · KMS, envelope encryption, key policies, grants, encryption context, rotation, and Secrets Manager](lessons/0481-kms-envelope-encryption-key-policies-grants-encryption-context-rotation-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0482 · VPCs, CIDR planning, subnets, route tables, local routes, IPv4, IPv6, and IP address management](lessons/0482-vpcs-cidr-planning-subnets-route-tables-local-routes-ipv4-ipv6-and-ip-ad.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0483 · Internet gateways, NAT gateways, egress-only gateways, VPC endpoints, PrivateLink, peering, and Transit Gateway](lessons/0483-internet-gateways-nat-gateways-egress-only-gateways-vpc-endpoints-privat.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0484 · Security groups, network ACLs, Network Firewall, DNS Resolver, VPC Flow Logs, and packet diagnosis](lessons/0484-security-groups-network-acls-network-firewall-dns-resolver-vpc-flow-logs.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0485 · Route 53 zones, records, aliases, health checks, routing policies, DNSSEC, and failover](lessons/0485-route-53-zones-records-aliases-health-checks-routing-policies-dnssec-and.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0486 · CloudFront distributions, origins, cache keys, behaviors, invalidation, signed access, WAF, and edge security](lessons/0486-cloudfront-distributions-origins-cache-keys-behaviors-invalidation-signe.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0487 · Elastic Load Balancing, ALB, NLB, listeners, target groups, health checks, TLS, and connection behavior](lessons/0487-elastic-load-balancing-alb-nlb-listeners-target-groups-health-checks-tls.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0488 · EC2 instance families, AMIs, user data, metadata, IMDSv2, placement, Auto Scaling, and lifecycle](lessons/0488-ec2-instance-families-amis-user-data-metadata-imdsv2-placement-auto-scal.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0489 · EBS, instance store, EFS, FSx, snapshots, encryption, performance, attachment, and durability](lessons/0489-ebs-instance-store-efs-fsx-snapshots-encryption-performance-attachment-a.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0490 · S3 buckets, objects, consistency, versioning, lifecycle, replication, events, policies, and data protection](lessons/0490-s3-buckets-objects-consistency-versioning-lifecycle-replication-events-p.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0491 · ECR, ECS task definitions, services, capacity providers, Fargate, EC2 launch type, and deployments](lessons/0491-ecr-ecs-task-definitions-services-capacity-providers-fargate-ec2-launch-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0492 · Lambda execution environments, handlers, cold starts, concurrency, event sources, layers, and failure semantics](lessons/0492-lambda-execution-environments-handlers-cold-starts-concurrency-event-sou.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0493 · API Gateway HTTP APIs, REST APIs, WebSocket APIs, integrations, authorizers, throttling, and stages](lessons/0493-api-gateway-http-apis-rest-apis-websocket-apis-integrations-authorizers-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0494 · RDS, Aurora, Multi-AZ, read replicas, backups, failover, parameter groups, IAM auth, and RDS Proxy](lessons/0494-rds-aurora-multi-az-read-replicas-backups-failover-parameter-groups-iam-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0495 · DynamoDB partition keys, sort keys, indexes, capacity, adaptive behavior, consistency, transactions, TTL, and streams](lessons/0495-dynamodb-partition-keys-sort-keys-indexes-capacity-adaptive-behavior-con.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0496 · ElastiCache Redis, cache-aside, TTL, eviction, clustering, replication, failover, and stampede control](lessons/0496-elasticache-redis-cache-aside-ttl-eviction-clustering-replication-failov.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0497 · SQS, SNS, standard queues, FIFO, visibility timeouts, DLQs, long polling, fan-out, and idempotency](lessons/0497-sqs-sns-standard-queues-fifo-visibility-timeouts-dlqs-long-polling-fan-o.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0498 · EventBridge buses, rules, schemas, archives, replay, Scheduler, Step Functions, retries, and compensation](lessons/0498-eventbridge-buses-rules-schemas-archives-replay-scheduler-step-functions.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0499 · Kinesis Data Streams, Firehose, MSK, shards, partitions, consumers, checkpoints, ordering, and streaming backpressure](lessons/0499-kinesis-data-streams-firehose-msk-shards-partitions-consumers-checkpoint.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0500 · CloudWatch metrics, logs, alarms, dashboards, Logs Insights, X-Ray, OpenTelemetry, and correlation](lessons/0500-cloudwatch-metrics-logs-alarms-dashboards-logs-insights-x-ray-openteleme.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0501 · CloudTrail, AWS Config, GuardDuty, Security Hub, Detective, audit trails, detection, and response](lessons/0501-cloudtrail-aws-config-guardduty-security-hub-detective-audit-trails-dete.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0502 · CloudFormation, CDK, stacks, change sets, dependencies, custom resources, drift, and infrastructure testing](lessons/0502-cloudformation-cdk-stacks-change-sets-dependencies-custom-resources-drif.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0503 · AWS reliability, Well-Architected pillars, quotas, multi-AZ design, backups, disaster recovery, RTO, and RPO](lessons/0503-aws-reliability-well-architected-pillars-quotas-multi-az-design-backups-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0504 · AWS cost models, tags, CUR, Cost Explorer, Budgets, rightsizing, Savings Plans, Spot, and FinOps](lessons/0504-aws-cost-models-tags-cur-cost-explorer-budgets-rightsizing-savings-plans.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0505 · Amazon Bedrock, SageMaker, model access, inference, agents, knowledge bases, guardrails, evaluation, and AI security](lessons/0505-amazon-bedrock-sagemaker-model-access-inference-agents-knowledge-bases-g.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0506 · Cloud and AWS production architecture capstone, full-stack AI delivery, security, reliability, cost, and incident defense](lessons/0506-cloud-and-aws-production-architecture-capstone-full-stack-ai-delivery-se.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## DevOps Complete Deep Dive

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0507 · DevOps principles, CALMS, flow, feedback, learning, ownership, and socio-technical systems](lessons/0507-devops-principles-calms-flow-feedback-learning-ownership-and-socio-techn.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0508 · Linux processes, systemd, services, users, permissions, signals, limits, and resource diagnosis](lessons/0508-linux-processes-systemd-services-users-permissions-signals-limits-and-re.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0509 · Networking diagnostics, DNS, routing, TCP, TLS, HTTP, proxies, load balancers, and timeouts](lessons/0509-networking-diagnostics-dns-routing-tcp-tls-http-proxies-load-balancers-a.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0510 · Shell automation, strict mode, quoting, pipes, exit codes, idempotency, traps, and portable scripts](lessons/0510-shell-automation-strict-mode-quoting-pipes-exit-codes-idempotency-traps-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0511 · Git workflows, trunk-based development, branches, pull requests, reviews, rebasing, releases, and recovery](lessons/0511-git-workflows-trunk-based-development-branches-pull-requests-reviews-reb.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0512 · CI pipeline graphs, triggers, runners, jobs, matrices, caches, artifacts, concurrency, and reproducibility](lessons/0512-ci-pipeline-graphs-triggers-runners-jobs-matrices-caches-artifacts-concu.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0513 · Automated testing strategy, unit, integration, contract, end-to-end, performance, and quality gates](lessons/0513-automated-testing-strategy-unit-integration-contract-end-to-end-performa.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0514 · Software supply chain, dependency trust, SBOMs, provenance, signing, attestations, and SLSA concepts](lessons/0514-software-supply-chain-dependency-trust-sboms-provenance-signing-attestat.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0515 · CI identity, OIDC federation, secrets, environments, approvals, least privilege, and runner security](lessons/0515-ci-identity-oidc-federation-secrets-environments-approvals-least-privile.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0516 · Artifact repositories, semantic versioning, immutable releases, promotion, retention, and rollback identity](lessons/0516-artifact-repositories-semantic-versioning-immutable-releases-promotion-r.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0517 · Configuration, environment variables, feature flags, secrets, dynamic config, validation, and drift](lessons/0517-configuration-environment-variables-feature-flags-secrets-dynamic-config.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0518 · Deployment strategies, rolling, recreate, blue-green, canary, feature release, health checks, and rollback](lessons/0518-deployment-strategies-rolling-recreate-blue-green-canary-feature-release.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0519 · Database delivery, expand-contract migrations, backward compatibility, data backfills, locks, and rollback](lessons/0519-database-delivery-expand-contract-migrations-backward-compatibility-data.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0520 · Observability, SLIs, SLOs, error budgets, metrics, logs, traces, alerts, and dashboards](lessons/0520-observability-slis-slos-error-budgets-metrics-logs-traces-alerts-and-das.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0521 · Incident response, severity, command, communication, mitigation, recovery, and blameless postmortems](lessons/0521-incident-response-severity-command-communication-mitigation-recovery-and.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0522 · Capacity planning, load testing, queues, saturation, autoscaling, performance budgets, and load shedding](lessons/0522-capacity-planning-load-testing-queues-saturation-autoscaling-performance.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0523 · Infrastructure as code, desired state, plans, modules, state, drift, policy checks, and change review](lessons/0523-infrastructure-as-code-desired-state-plans-modules-state-drift-policy-ch.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0524 · Platform engineering, internal developer platforms, golden paths, self-service, APIs, scorecards, and product thinking](lessons/0524-platform-engineering-internal-developer-platforms-golden-paths-self-serv.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0525 · DevSecOps, threat modeling, secure defaults, policy as code, compliance evidence, and vulnerability response](lessons/0525-devsecops-threat-modeling-secure-defaults-policy-as-code-compliance-evid.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0526 · DevOps production delivery capstone, value stream, pipeline, infrastructure, observability, incident, and improvement](lessons/0526-devops-production-delivery-capstone-value-stream-pipeline-infrastructure.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Docker Complete Deep Dive

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0527 · Docker architecture, client, daemon, API, containerd, runc, registries, and object lifecycle](lessons/0527-docker-architecture-client-daemon-api-containerd-runc-registries-and-obj.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0528 · Images, containers, read-only layers, writable layers, content digests, tags, and lifecycle](lessons/0528-images-containers-read-only-layers-writable-layers-content-digests-tags-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0529 · Dockerfile FROM, RUN, COPY, ADD, WORKDIR, USER, ENV, ARG, EXPOSE, and metadata](lessons/0529-dockerfile-from-run-copy-add-workdir-user-env-arg-expose-and-metadata.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0530 · Build context, .dockerignore, layers, cache keys, invalidation, ordering, and reproducible builds](lessons/0530-build-context-dockerignore-layers-cache-keys-invalidation-ordering-and-r.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0531 · BuildKit, multi-stage builds, named stages, targets, cache mounts, secret mounts, SSH mounts, and outputs](lessons/0531-buildkit-multi-stage-builds-named-stages-targets-cache-mounts-secret-mou.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0532 · CMD, ENTRYPOINT, exec form, shell form, arguments, environment expansion, and overrides](lessons/0532-cmd-entrypoint-exec-form-shell-form-arguments-environment-expansion-and-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0533 · PID 1, signals, process reaping, init, graceful shutdown, stop timeout, and application lifecycle](lessons/0533-pid-1-signals-process-reaping-init-graceful-shutdown-stop-timeout-and-ap.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0534 · Linux namespaces, cgroups, capabilities, seccomp, AppArmor, SELinux, and container isolation](lessons/0534-linux-namespaces-cgroups-capabilities-seccomp-apparmor-selinux-and-conta.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0535 · Rootless Docker, user namespaces, non-root users, read-only filesystems, no-new-privileges, and hardening](lessons/0535-rootless-docker-user-namespaces-non-root-users-read-only-filesystems-no-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0536 · Docker networking, bridge, host, none, user-defined networks, DNS, NAT, published ports, and IPv6](lessons/0536-docker-networking-bridge-host-none-user-defined-networks-dns-nat-publish.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0537 · Overlay filesystems, container writable state, volumes, bind mounts, tmpfs, ownership, backup, and performance](lessons/0537-overlay-filesystems-container-writable-state-volumes-bind-mounts-tmpfs-o.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0538 · Docker Compose services, projects, networks, volumes, profiles, dependencies, environment, and overrides](lessons/0538-docker-compose-services-projects-networks-volumes-profiles-dependencies-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0539 · Health checks, readiness, startup ordering, restart policies, dependency failure, and self-healing limits](lessons/0539-health-checks-readiness-startup-ordering-restart-policies-dependency-fai.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0540 · Container logs, stdout, stderr, logging drivers, docker stats, events, metrics, and retention](lessons/0540-container-logs-stdout-stderr-logging-drivers-docker-stats-events-metrics.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0541 · Container debugging, inspect, logs, exec, top, diff, events, network namespaces, and minimal images](lessons/0541-container-debugging-inspect-logs-exec-top-diff-events-network-namespaces.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0542 · Registries, repositories, tags, digests, authentication, push, pull, garbage collection, and retention](lessons/0542-registries-repositories-tags-digests-authentication-push-pull-garbage-co.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0543 · Multi-platform images, buildx, builders, emulation, cross-compilation, manifests, and platform selection](lessons/0543-multi-platform-images-buildx-builders-emulation-cross-compilation-manife.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0544 · Container supply-chain security, base images, vulnerabilities, SBOMs, provenance, signing, and policy](lessons/0544-container-supply-chain-security-base-images-vulnerabilities-sboms-proven.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0545 · Production image optimization, dependency caching, distroless, resource limits, immutability, and operational tradeoffs](lessons/0545-production-image-optimization-dependency-caching-distroless-resource-lim.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0546 · Docker production capstone, build, Compose, security, networking, storage, observability, and incident diagnosis](lessons/0546-docker-production-capstone-build-compose-security-networking-storage-obs.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Kubernetes Complete Deep Dive

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0547 · Kubernetes purpose, declarative APIs, desired state, control plane, nodes, workloads, and orchestration tradeoffs](lessons/0547-kubernetes-purpose-declarative-apis-desired-state-control-plane-nodes-wo.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0548 · Kubernetes objects, apiVersion, kind, metadata, spec, status, UIDs, generations, resource versions, and etcd](lessons/0548-kubernetes-objects-apiversion-kind-metadata-spec-status-uids-generations.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0549 · API server, authentication, authorization, admission, validation, conversion, persistence, and audit](lessons/0549-api-server-authentication-authorization-admission-validation-conversion-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0550 · Controllers, reconciliation loops, watches, work queues, owner references, finalizers, and garbage collection](lessons/0550-controllers-reconciliation-loops-watches-work-queues-owner-references-fi.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0551 · Scheduler, pending Pods, filtering, scoring, binding, requests, constraints, plugins, and scheduling failure](lessons/0551-scheduler-pending-pods-filtering-scoring-binding-requests-constraints-pl.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0552 · Nodes, kubelet, CRI, container runtime, pod sandbox, image pulls, status, leases, and node failure](lessons/0552-nodes-kubelet-cri-container-runtime-pod-sandbox-image-pulls-status-lease.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0553 · Pods, shared network, volumes, lifecycle, restart policy, init containers, sidecars, and ephemeral containers](lessons/0553-pods-shared-network-volumes-lifecycle-restart-policy-init-containers-sid.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0554 · Startup, readiness, liveness probes, conditions, readiness gates, termination, grace periods, and draining](lessons/0554-startup-readiness-liveness-probes-conditions-readiness-gates-termination.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0555 · Deployments, ReplicaSets, rolling updates, maxSurge, maxUnavailable, progress, pause, and rollback](lessons/0555-deployments-replicasets-rolling-updates-maxsurge-maxunavailable-progress.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0556 · StatefulSets, stable identity, ordered rollout, headless Services, persistent storage, and failure recovery](lessons/0556-statefulsets-stable-identity-ordered-rollout-headless-services-persisten.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0557 · DaemonSets, node-local agents, update strategies, tolerations, priority, and system workload safety](lessons/0557-daemonsets-node-local-agents-update-strategies-tolerations-priority-and-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0558 · Jobs, CronJobs, completions, parallelism, backoff, deadlines, concurrency policy, and failure handling](lessons/0558-jobs-cronjobs-completions-parallelism-backoff-deadlines-concurrency-poli.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0559 · Services, ClusterIP, NodePort, LoadBalancer, EndpointSlices, selectors, kube-proxy, and traffic policies](lessons/0559-services-clusterip-nodeport-loadbalancer-endpointslices-selectors-kube-p.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0560 · Ingress, ingress controllers, Gateway API, routes, listeners, TLS, load balancers, and north-south traffic](lessons/0560-ingress-ingress-controllers-gateway-api-routes-listeners-tls-load-balanc.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0561 · Cluster DNS, CoreDNS, Service discovery, search domains, ndots, caching, and DNS debugging](lessons/0561-cluster-dns-coredns-service-discovery-search-domains-ndots-caching-and-d.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0562 · Kubernetes network model, CNI, Pod IPs, routing, encapsulation, NetworkPolicy, ingress, egress, and isolation](lessons/0562-kubernetes-network-model-cni-pod-ips-routing-encapsulation-networkpolicy.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0563 · ConfigMaps, Secrets, environment variables, projected volumes, Downward API, reload, encryption, and external secret stores](lessons/0563-configmaps-secrets-environment-variables-projected-volumes-downward-api-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0564 · CPU and memory requests, limits, cgroups, QoS classes, throttling, OOM, eviction, and resource diagnosis](lessons/0564-cpu-and-memory-requests-limits-cgroups-qos-classes-throttling-oom-evicti.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0565 · PersistentVolumes, PVCs, StorageClasses, CSI, dynamic provisioning, access modes, reclaim policy, and snapshots](lessons/0565-persistentvolumes-pvcs-storageclasses-csi-dynamic-provisioning-access-mo.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0566 · Namespaces, labels, selectors, annotations, quotas, LimitRanges, multi-tenancy, and isolation boundaries](lessons/0566-namespaces-labels-selectors-annotations-quotas-limitranges-multi-tenancy.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0567 · ServiceAccounts, RBAC Roles, ClusterRoles, bindings, verbs, resources, subresources, and least privilege](lessons/0567-serviceaccounts-rbac-roles-clusterroles-bindings-verbs-resources-subreso.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0568 · SecurityContext, users, groups, capabilities, seccomp, AppArmor, Pod Security Standards, and admission](lessons/0568-securitycontext-users-groups-capabilities-seccomp-apparmor-pod-security-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0569 · Horizontal Pod Autoscaler, Vertical Pod Autoscaler, cluster autoscaling, metrics, stabilization, and scaling limits](lessons/0569-horizontal-pod-autoscaler-vertical-pod-autoscaler-cluster-autoscaling-me.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0570 · Affinity, anti-affinity, topology spread, taints, tolerations, priority, preemption, disruption budgets, and drains](lessons/0570-affinity-anti-affinity-topology-spread-taints-tolerations-priority-preem.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0571 · Kubernetes observability, events, logs, metrics, API audit, traces, control-plane signals, and SLOs](lessons/0571-kubernetes-observability-events-logs-metrics-api-audit-traces-control-pl.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0572 · Kubernetes debugging, Pending, ImagePullBackOff, CrashLoopBackOff, OOMKilled, DNS, networking, storage, and nodes](lessons/0572-kubernetes-debugging-pending-imagepullbackoff-crashloopbackoff-oomkilled.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0573 · Helm, charts, templates, values, releases, hooks, dependencies, Kustomize, overlays, and configuration management](lessons/0573-helm-charts-templates-values-releases-hooks-dependencies-kustomize-overl.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0574 · GitOps, reconciliation, drift, pull-based delivery, CRDs, operators, webhooks, and API extension](lessons/0574-gitops-reconciliation-drift-pull-based-delivery-crds-operators-webhooks-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0575 · Cluster operations, version skew, upgrades, node replacement, etcd backup, disaster recovery, and EKS boundaries](lessons/0575-cluster-operations-version-skew-upgrades-node-replacement-etcd-backup-di.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0576 · Kubernetes production capstone, architecture, security, delivery, scaling, observability, failure injection, and operations](lessons/0576-kubernetes-production-capstone-architecture-security-delivery-scaling-ob.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Mathematics and Machine Learning Foundations

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0577 · Vectors, matrices, similarity, projections, and probability](lessons/0577-vectors-matrices-similarity-projections-and-probability.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0578 · Optimization, gradients, loss functions, regularization, and generalization](lessons/0578-optimization-gradients-loss-functions-regularization-and-generalization.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0579 · Data splits, leakage, imbalance, metrics, and experiment design](lessons/0579-data-splits-leakage-imbalance-metrics-and-experiment-design.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0580 · Classical ML, embeddings, clustering, ranking, and recommendation intuition](lessons/0580-classical-ml-embeddings-clustering-ranking-and-recommendation-intuition.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## LLM and Transformer Internals

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0581 · Tokenization, vocabulary, embeddings, positional information, and context windows](lessons/0581-tokenization-vocabulary-embeddings-positional-information-and-context-wi.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0582 · Attention, transformer blocks, residual streams, normalization, and feed-forward layers](lessons/0582-attention-transformer-blocks-residual-streams-normalization-and-feed-for.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0583 · Pretraining, next-token prediction, fine-tuning, instruction tuning, and preference optimization](lessons/0583-pretraining-next-token-prediction-fine-tuning-instruction-tuning-and-pre.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0584 · Decoding, temperature, top-p, determinism, caching, batching, and quantization](lessons/0584-decoding-temperature-top-p-determinism-caching-batching-and-quantization.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0585 · Hallucination, calibration, long-context limits, reasoning claims, and failure analysis](lessons/0585-hallucination-calibration-long-context-limits-reasoning-claims-and-failu.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## AI Application Engineering

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0586 · Model APIs, messages, instructions, multimodal inputs, streaming, and provider abstraction](lessons/0586-model-apis-messages-instructions-multimodal-inputs-streaming-and-provide.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0587 · Prompt design, context engineering, examples, delimiters, and prompt versioning](lessons/0587-prompt-design-context-engineering-examples-delimiters-and-prompt-version.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0588 · Structured outputs, schemas, parsing, validation, and repair](lessons/0588-structured-outputs-schemas-parsing-validation-and-repair.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0589 · Tool calling, execution boundaries, permissions, and human approval](lessons/0589-tool-calling-execution-boundaries-permissions-and-human-approval.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0590 · Latency, cost, caching, fallbacks, rate limits, and model routing](lessons/0590-latency-cost-caching-fallbacks-rate-limits-and-model-routing.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0591 · AI frontend streaming, fetch streams, SSE, event framing, incremental state, cancellation, reconnection, and backpressure](lessons/0591-ai-frontend-streaming-fetch-streams-sse-event-framing-incremental-state-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0592 · Generative UI, structured message parts, tool calls, human approval, optimistic state, errors, and accessibility](lessons/0592-generative-ui-structured-message-parts-tool-calls-human-approval-optimis.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0593 · Conversation persistence, message identity, server authority, resumable streams, authentication, privacy, testing, and evaluation](lessons/0593-conversation-persistence-message-identity-server-authority-resumable-str.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Search, Embeddings, and RAG

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0594 · Information retrieval fundamentals, lexical search, dense retrieval, and hybrid search](lessons/0594-information-retrieval-fundamentals-lexical-search-dense-retrieval-and-hy.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0595 · Ingestion, parsing, cleaning, metadata, chunking, and indexing](lessons/0595-ingestion-parsing-cleaning-metadata-chunking-and-indexing.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0596 · Query rewriting, filtering, reranking, context assembly, and citations](lessons/0596-query-rewriting-filtering-reranking-context-assembly-and-citations.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0597 · RAG evaluation, golden sets, retrieval metrics, answer metrics, and regression testing](lessons/0597-rag-evaluation-golden-sets-retrieval-metrics-answer-metrics-and-regressi.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0598 · Advanced retrieval, freshness, permissions, and operational failure modes](lessons/0598-advanced-retrieval-freshness-permissions-and-operational-failure-modes.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0599 · Vector database data model, embeddings, dimensions, distance metrics, metadata, filtering, upserts, deletes, and query execution](lessons/0599-vector-database-data-model-embeddings-dimensions-distance-metrics-metada.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0600 · Vector index internals, exact search, HNSW graphs, IVF lists, product quantization, recall, memory, and build cost](lessons/0600-vector-index-internals-exact-search-hnsw-graphs-ivf-lists-product-quanti.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0601 · Vector database storage internals, segments, write-ahead logs, tombstones, compaction, filtering plans, sharding, replication, and recovery](lessons/0601-vector-database-storage-internals-segments-write-ahead-logs-tombstones-c.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0602 · Portfolio Project 2 — evaluated knowledge product](lessons/0602-portfolio-project-2-evaluated-knowledge-product.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Agents and Durable AI Workflows

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0603 · LLM system blueprint, workflows versus agents, ReAct, state machines, planners, and control loops](lessons/0603-llm-system-blueprint-workflows-versus-agents-react-state-machines-planne.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0604 · Tool design, descriptions, schemas, state, memory, and context management](lessons/0604-tool-design-descriptions-schemas-state-memory-and-context-management.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0605 · LangChain v1 agents, models, messages, tools, middleware, structured output, streaming, and tracing](lessons/0605-langchain-v1-agents-models-messages-tools-middleware-structured-output-s.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0606 · LangGraph StateGraph, Pydantic state schemas, nodes, edges, reducers, checkpoints, interrupts, and durable execution](lessons/0606-langgraph-stategraph-pydantic-state-schemas-nodes-edges-reducers-checkpo.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0607 · Model Context Protocol architecture, hosts, clients, servers, JSON-RPC, initialization, capabilities, tools, resources, prompts, and lifecycle](lessons/0607-model-context-protocol-architecture-hosts-clients-servers-json-rpc-initi.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0608 · MCP transports, Streamable HTTP, sessions, authorization, consent, security, testing, and observability](lessons/0608-mcp-transports-streamable-http-sessions-authorization-consent-security-t.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0609 · Checkpoints, retries, idempotency, human-in-the-loop, and recovery](lessons/0609-checkpoints-retries-idempotency-human-in-the-loop-and-recovery.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0610 · Multi-agent patterns, coordination costs, and failure containment](lessons/0610-multi-agent-patterns-coordination-costs-and-failure-containment.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0611 · Agent evaluation, traces, budgets, security, and stopping conditions](lessons/0611-agent-evaluation-traces-budgets-security-and-stopping-conditions.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## AI Evaluations, Observability, and Safety

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0612 · Evaluation objectives, datasets, rubrics, baselines, and slices](lessons/0612-evaluation-objectives-datasets-rubrics-baselines-and-slices.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0613 · Deterministic checks, model graders, human review, and judge calibration](lessons/0613-deterministic-checks-model-graders-human-review-and-judge-calibration.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0614 · LLM benchmarking, representative datasets, baselines, repetitions, quality metrics, latency, cost, and statistical uncertainty](lessons/0614-llm-benchmarking-representative-datasets-baselines-repetitions-quality-m.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0615 · Prompt injection, data exfiltration, tool abuse, and untrusted content](lessons/0615-prompt-injection-data-exfiltration-tool-abuse-and-untrusted-content.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0616 · AI traces, quality monitoring, drift, feedback, and incident response](lessons/0616-ai-traces-quality-monitoring-drift-feedback-and-incident-response.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0617 · Privacy, fairness, compliance, model risk, and product boundaries](lessons/0617-privacy-fairness-compliance-model-risk-and-product-boundaries.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## Production Capstone

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0618 · Product discovery, users, success metrics, constraints, and architecture](lessons/0618-product-discovery-users-success-metrics-constraints-and-architecture.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0619 · End-to-end implementation across React, Node.js or FastAPI, data, and AI](lessons/0619-end-to-end-implementation-across-react-node-js-or-fastapi-data-and-ai.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0620 · Quality, security, evaluation, observability, deployment, and operations](lessons/0620-quality-security-evaluation-observability-deployment-and-operations.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0621 · Portfolio narrative, demo, case study, and architecture defense](lessons/0621-portfolio-narrative-demo-case-study-and-architecture-defense.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |

## International Interviews and Relocation Readiness Complete Module

| Lesson | Content status | Individual evidence |
| --- | --- | --- |
| [0622 · Role targeting, job-description analysis, skill signals, gap mapping, and evidence selection](lessons/0622-role-targeting-job-description-analysis-skill-signals-gap-mapping-and-ev.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0623 · Resume architecture, ATS parsing, achievement bullets, keywords, credibility, and tailoring](lessons/0623-resume-architecture-ats-parsing-achievement-bullets-keywords-credibility.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0624 · LinkedIn profile, headline, About, experience, skills, Open to Work, and discoverability](lessons/0624-linkedin-profile-headline-about-experience-skills-open-to-work-and-disco.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0625 · GitHub profile, pinned repositories, portfolio evidence, READMEs, demos, and engineering credibility](lessons/0625-github-profile-pinned-repositories-portfolio-evidence-readmes-demos-and-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0626 · Job portals, company career pages, search queries, filters, alerts, sourcing channels, and fraud checks](lessons/0626-job-portals-company-career-pages-search-queries-filters-alerts-sourcing-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0627 · Application tracking, prioritization, personalized outreach, follow-ups, analytics, and safe automation](lessons/0627-application-tracking-prioritization-personalized-outreach-follow-ups-ana.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0628 · Recruiter screens, career narrative, introduction, motivation, scope, compensation, and availability](lessons/0628-recruiter-screens-career-narrative-introduction-motivation-scope-compens.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0629 · Coding interview method, clarification, examples, invariants, brute force, optimization, complexity, and tests](lessons/0629-coding-interview-method-clarification-examples-invariants-brute-force-op.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0630 · JavaScript and Python coding interviews, language fluency, debugging, standard libraries, and execution](lessons/0630-javascript-and-python-coding-interviews-language-fluency-debugging-stand.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0631 · Full-stack technical interviews, JavaScript, Node.js, Python, React, FastAPI, data, cloud, and operations](lessons/0631-full-stack-technical-interviews-javascript-node-js-python-react-fastapi-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0632 · System-design interviews, requirements, estimates, APIs, data, scaling, reliability, and evolution](lessons/0632-system-design-interviews-requirements-estimates-apis-data-scaling-reliab.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0633 · AI engineering interviews, model behavior, RAG, agents, evaluations, safety, latency, and cost](lessons/0633-ai-engineering-interviews-model-behavior-rag-agents-evaluations-safety-l.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0634 · Situational interview questions, hypothetical scenarios, clarification, principles, options, tradeoffs, decisions, and model answers](lessons/0634-situational-interview-questions-hypothetical-scenarios-clarification-pri.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0635 · Behavioral story bank, STAR, decisions, actions, results, metrics, and reflection](lessons/0635-behavioral-story-bank-star-decisions-actions-results-metrics-and-reflect.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0636 · Leadership, ownership, conflict, failure, feedback, ambiguity, and cross-cultural collaboration](lessons/0636-leadership-ownership-conflict-failure-feedback-ambiguity-and-cross-cultu.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0637 · Technical storytelling, audience, context, stakes, tension, decisions, evidence, clarity, and brevity](lessons/0637-technical-storytelling-audience-context-stakes-tension-decisions-evidenc.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0638 · Influence without authority, stakeholder mapping, listening, incentives, framing, credibility, coalition building, disagreement, and escalation](lessons/0638-influence-without-authority-stakeholder-mapping-listening-incentives-fra.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0639 · Ethical persuasion, transparency, consent, autonomy, incentives, nudges, dark patterns, coercion, deception, and manipulation boundaries](lessons/0639-ethical-persuasion-transparency-consent-autonomy-incentives-nudges-dark-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0640 · Portfolio presentations, project walkthroughs, architecture diagrams, demos, tradeoffs, and live questions](lessons/0640-portfolio-presentations-project-walkthroughs-architecture-diagrams-demos.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0641 · Networking, open source, referrals, communities, outreach, and international communication](lessons/0641-networking-open-source-referrals-communities-outreach-and-international-.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0642 · Salary negotiation, market evidence, total compensation, ranges, anchors, BATNA, priorities, scripts, counteroffers, and written terms](lessons/0642-salary-negotiation-market-evidence-total-compensation-ranges-anchors-bat.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0643 · Relocation readiness, work authorization, sponsorship, official research, offer evaluation, and negotiation](lessons/0643-relocation-readiness-work-authorization-sponsorship-official-research-of.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
| [0644 · Mock interview loops, scorecards, recordings, error logs, feedback, spaced retrieval, and improvement cycles](lessons/0644-mock-interview-loops-scorecards-recordings-error-logs-feedback-spaced-re.html) | Final review pending | Final sign-off not recorded; reuse prior batch notes |
